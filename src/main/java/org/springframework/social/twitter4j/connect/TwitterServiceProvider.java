...
public final class TwitterServiceProvider extends AbstractOAuth1ServiceProvider<Twitter> {
	...
	public Twitter getApi(String accessToken, String secret) {
		...
		props.setProperty("oauth.consumerKey", getConsumerKey());
		props.setProperty("oauth.consumerSecret", getConsumerSecret());
		props.setProperty("oauth.accessToken", accessToken);
		props.setProperty("oauth.accessTokenSecret", secret);
